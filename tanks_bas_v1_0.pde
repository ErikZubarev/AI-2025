...
void setup() 
{
  ...
  tank3 = new Tank("tank3", team1_tank0_startpos, blue_tank_img );
  tank4 = new Tank("tank4", team1_tank1_startpos, blue_tank_img );
  tank5 = new Tank("tank5", team1_tank2_startpos, blue_tank_img );
